...
glenum2str(GLenum e)
{
    ...
    case GL_IMPLEMENTATION_COLOR_READ_TYPE_OES: return "GL_IMPLEMENTATION_COLOR_READ_TYPE_OES";
    case GL_IMPLEMENTATION_COLOR_READ_FORMAT_OES: return "GL_IMPLEMENTATION_COLOR_READ_FORMAT_OES";
    ...
    case GL_POINT_SIZE_ARRAY_POINTER_OES: return "GL_POINT_SIZE_ARRAY_POINTER_OES";
    case GL_POINT_SIZE_ARRAY_BUFFER_BINDING_OES: return "GL_POINT_SIZE_ARRAY_BUFFER_BINDING_OES";
